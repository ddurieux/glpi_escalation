...
define ("PLUGIN_ESCALATION_VERSION", "9.5+1.0");

// Init the hooks of escalation
function plugin_init_escalation() {
   global $PLUGIN_HOOKS;

   $PLUGIN_HOOKS['change_profile']['escalation'] = ['PluginEscalationProfile','changeprofile'];
   ...
   if (isset($_SESSION["glpiID"])) {
      ...
      $PLUGIN_HOOKS['pre_item_add']['escalation'] = [
         'Ticket' => [
            'PluginEscalationGroup_Group',
            'selectGroupOnAdd'
         ]
      ];
      $PLUGIN_HOOKS['item_add']['escalation'] = [
         'Ticket' => [
            'PluginEscalationTicketCopy',
            'finishAdd'
         ]
      ];
      $PLUGIN_HOOKS['pre_item_update']['escalation'] = ['Ticket' => ['PluginEscalationGroup_Group', 'notMultiple']];
   }
}
